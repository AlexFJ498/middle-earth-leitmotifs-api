...
import (
	...
	query "github.com/AlexFJ498/middle-earth-leitmotifs-api/kit/query"
...
// Ask provides a mock function with given fields: ctx, _a1
func (_m *Bus) Ask(ctx context.Context, _a1 query.Query) (interface{}, error) {
